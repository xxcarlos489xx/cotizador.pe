...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
		...
		<table class="page_footer">
			<tr>
				...
				<td style="width: 50%; text-align: right">
					&copy; <?php echo "dmqvirucida.com.pe "; echo  $anio=date('Y'); ?>
				</td>
			</tr>
		</table>
	</page_footer>
	<table cellspacing="0" style="width: 100%;">
		<tr>
			...
			<td style="width: 75%;text-align:right">
				COTIZACION Nº <?php echo ($numero_cotizacion)+100;?>
			</td>
	...
	<table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
		<tr>
			<td style="width:50%; "><strong>www.dmqVirucida.com.pe</strong> <!--<br>Calle Felipe de Zela Nro. 736 - Urb. Los Ficus<br>SANTA ANITA<br> Teléfono.: 992-745-818--></td>
...
<table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 11pt;padding:1mm;">
	<tr>
		...
		<th style="width: 13%; text-align: right;">S/. <?php echo number_format($sumador_total,2);?></th>
	</tr>
</table>
